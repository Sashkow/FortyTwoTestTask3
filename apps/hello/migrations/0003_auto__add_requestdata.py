...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'hello_requestdata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pickled_request', self.gf('django.db.models.fields.TextField')(default='Empty')),
        ))
        db.send_create_signal(u'hello', ['RequestData'])


    def backwards(self, orm):
        # Deleting model 'RequestData'
        db.delete_table(u'hello_requestdata')
