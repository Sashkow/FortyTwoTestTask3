...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.ava'
        db.add_column(u'hello_person', 'ava',
                      self.gf('stdimage.models.StdImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.ava'
        db.delete_column(u'hello_person', 'ava')
