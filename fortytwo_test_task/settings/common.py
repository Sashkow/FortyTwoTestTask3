...
SELENIUM_PATH = os.path.join(BASE_DIR, 'selenium-server-2.6.jar')
...
# SELENIUM_TEST_RUNNER = 'django_selenium.selenium_runner.SeleniumTestRunner'
...
# SELENIUM_TEST_SERVER_TIMEOUT = 300
...
# SELENIUM_CAPABILITY = 'FIREFOX'
# SELENIUM_DRIVER = 'Remote'
# SELENIUM_HOST = 'selenium-hub.example.com'
# SELENIUM_TESTSERVER_HOST = '0.0.0.0'
# #------------------------------------------------------------